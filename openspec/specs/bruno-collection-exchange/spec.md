# bruno-collection-exchange Specification

## Purpose

Import and export of Bruno collections as the exchange format for sharing API requests between users, including request-to-endpoint matching, OAuth2 scope round-tripping, session-scoped import browsing, and guidance for unrecognized imports.
