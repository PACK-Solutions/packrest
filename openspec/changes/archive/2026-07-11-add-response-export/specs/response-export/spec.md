...
The system SHALL convert the parsed response body into a valid Excel `.xlsx` workbook, generated entirely client-side, that opens in Excel and other spreadsheet applications without a conversion prompt.
