...
// (No beneficiary-clause generator: the clause is not random data. It is a
// context value of the parcours — DEFAULT_BENEFICIARY_CLAUSE in lib/parcours.ts —
// so every mode sends the same designation and an edit survives the next step.)
